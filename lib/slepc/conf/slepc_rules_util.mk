...
vermin_slepc:
	@vermin --violations -t=3.6- ${VERMIN_OPTIONS} ${SLEPC_DIR}/config
	@vermin --violations -t=3.6- --exclude-regex '\.pyi$$' --exclude-regex '-env' --exclude-regex 'docs/source/reference/' ${VERMIN_OPTIONS} ${SLEPC_DIR}/src/binding/slepc4py
